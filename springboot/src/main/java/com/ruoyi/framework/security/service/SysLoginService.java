...
public class SysLoginService {
    ...
    public String login(String username, String password, String code, String uuid) {
        ...
        if (captcha == null) {
             ...
             *  execute传入TimerTask对象(TimerTask是一个抽象类，它实现了Runnable接口，我们可以重写Runnable接口的run方法,设置线程任务),最后根据参数获取用户登录的信息还有失败的原因封装到logininfor最后使用自己封装的SpringUtils来获取记录日志的bean，执行方法插入数据库。
             */
